...
BEGIN
    INSERT INTO condominium (name,ruc,phone,email,landline,description,user_created,user_updated)
    VALUE (name,ruc,phone,email,landline,description,user_created,user_updated);
END $$
DELIMITER ;

...
BEGIN
    INSERT INTO building (id_condominium,name_building,description,floor,address,user_created,user_updated)
    VALUE (id_condominium,name_building,description,floor,address,user_created,user_updated);
END $$
DELIMITER ;
